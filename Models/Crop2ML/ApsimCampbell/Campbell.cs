...
public class Campbell
{
    ...
    /// <summary>
    /// initialization of the Campbell component
    /// </summary>
    ...
    [Description("number of soil layers in profile")]
    [Units("dimensionless")]
    //[Crop2ML(datatype="INT", min=1, max=null, default=10, parametercategory=constant, inputtype="parameter")]
    public int NLAYR
    {
    ...
    [Description("Soil layer thickness of layers")]
    [Units("mm")]
    //[Crop2ML(datatype="DOUBLEARRAY", min=1, max=null, default=, parametercategory=constant, inputtype="parameter")]
    public double[] THICK
    {
    ...
    [Description("Proportion of CLAY in each layer of profile")]
    [Units("")]
    //[Crop2ML(datatype="DOUBLEARRAY", min=0, max=100, default=50, parametercategory=constant, inputtype="parameter")]
    public double[] CLAY
    {
    ...
    //[Crop2ML(datatype="DOUBLEARRAY", min=0, max=1, default=0.5, parametercategory=constant, inputtype="parameter")]
    public double[] SW
    {
        get { return this._SW; }
        set { this._SW= value; }
    ...
    [Description("Average annual air temperature")]
    [Units("")]
    //[Crop2ML(datatype="DOUBLE", min=-60, max=60, default=, parametercategory=constant, inputtype="parameter")]
    public double TAV
    {
    ...
    [Description("Amplitude air temperature")]
    [Units("")]
    //[Crop2ML(datatype="DOUBLE", min=-100, max=100, default=, parametercategory=constant, inputtype="parameter")]
    public double TAMP
    {
    ...
    [Description("Soil albedo")]
    [Units("dimensionless")]
    //[Crop2ML(datatype="DOUBLE", min=0, max=1, default=, parametercategory=constant, inputtype="parameter")]
    public double SALB
    {
    ...
    [Description("Default instrument height")]
    [Units("m")]
    //[Crop2ML(datatype="DOUBLE", min=0, max=null, default=1.2, parametercategory=constant, inputtype="parameter")]
    ...
    /// <summary>
    /// Algorithm of the Campbell component
    /// </summary>
